            ...
            <Stack direction="column" spacing={2} mb={4}>
              <Flex alignItems="center">
                ...
                <Text fontSize="md" as="span" ml={3}>
                  {data?.rental_start_date as unknown as string}
                </Text>
              </Flex>
              <Flex alignItems="center">
                <Text fontSize="lg" fontWeight="bold" as="span">
                ...
                <Text fontSize="md" as="span" ml={3}>
                  {data?.rental_end_date as unknown as string}
                </Text>
              </Flex>
              <Flex alignItems="center">
                <Text fontSize="lg" fontWeight="bold" as="span">
            ...
            <Box>
              ...
              {hasAccess('construction_tool', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Flex alignItems="center" mb={4}>
                  ...
                  <Text fontSize="md" as="span" ml={3}>
                    <Link as={NextLink} href={`/construction-tools/view/${data?.construction_tool?.id}`}>
                      {data?.construction_tool?.name}
                    </Link>
                  </Text>
                </Flex>
              )}
